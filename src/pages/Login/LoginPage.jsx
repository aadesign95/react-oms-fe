...
const LoginPage = () => {
  ...
  return (
    <Layout className="bg-slate-100 h-full">
      <div className="flex justify-center items-center bg-slate-100 h-screen">
        <div className="w-3/5 mx-auto bg-white h-fit rounded-2xl	shadow-sm p-3">
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-indigo-600 flex justify-center items-center rounded-xl ">
              <div className="mx-auto text-center p-10 text-white">
                <img src={IntroImage} alt="image" className="w-1/2 mx-auto" />
                <div className="my-4">
                  <h1 className="text-3xl font-bold mb-4">
                    Solusi Cerdas untuk Kelola Penjualan Online
                  </h1>
                  <p>
                    Optimalkan pengelolaan jualan online Anda dengan OrderEase!
                    Kelola pesanan, atur stok, pantau pengiriman, dan tingkatkan
                    produktivitas bisnis Anda dalam satu platform yang mudah
                    digunakan.
                  </p>
                </div>
              </div>
            ...
            <div className="p-10">
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-500 text-sm">
                  Masuk untuk mengelola pesanan, stok, dan tingkatkan penjualan
                  online Anda!
                </p>
              </div>
